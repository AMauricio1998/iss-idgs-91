<nav x-data="{ open: false }" class="bg-indigo-300 border-b border-gray-200 rounded px-2 sm:px-3 py-1">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <span class="mr-3 h-10 sm:h-20 rounded font-bold text-1xl" >Grupo ISS <i class="fa-solid fa-xl fa-building-wheat"></i></span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->id_rol == 2)
                        <x-nav-link :href="route('solicitudes-index-user')" :active="request()->routeIs('solicitudes-index-user')">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                            </svg>{{ __('Solicitudes') }}
                        </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            <div>{{ Auth::user()->name }} <span class="lg:hidden md:hidden">{{ Auth::user()->app }}</span></div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->id_rol == 2)
                <x-responsive-nav-link :href="route('solicitudes-index-user')" :active="request()->routeIs('solicitudes-index-user')">
                    {{ __('Solicitudes') }}
                </x-responsive-nav-link>
