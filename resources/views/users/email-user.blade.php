    ...
    <div role="article" aria-label="An email from Your Brand Name" lang="en"
        ...
        <header>
            ...
            <a href="https://litmus.com/community">
                <center><img src="https://i.mkt.lu/dl/thumb/82882342450/80174152020.jpg" alt="" height="80" width="100">
                </center>
            </a>
            ...
            <h1
                ...
                Se a generado una nueva solicitud.
            </h1>
        </header>
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <p>
                    <center>
                        <strong>Código de solicitud: </strong>{{ $nombre->codigo_solicitud }} <br>
                        <strong>Nombre:</strong> {{ $nombre->name }} {{ $nombre->app }} {{ $nombre->apm }}<br>
                        <strong>Área: </strong>{{ $nombre->nombre_area }}<br>
                        <strong>Fecha de creación:</strong> {{ $nombre->created_at }}
                    </center>
                </p>
            </div>
        </main>
        ...
        <td align="center" height="100%" valign="top" width="100%" bgcolor="#FFFFFF" style="padding: 40px 15px;">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;"
                ...
                <tr>
                    <td align="center">
                        <img src="https://www.grupoiis.com/wp-content/uploads/2020/12/logo-grupoiis.png" width="200px"
                            height="100px">
                    </td>
                </tr>
                <tr>
                    <td align="center" valign="top"
                        ...
                        <p style="font-size: 14px; line-height: 20px;">
                            Mas que un servicio, una solicion
                            <br><br>
